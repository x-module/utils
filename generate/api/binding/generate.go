...
`)
			...
			tsContent.WriteString(`// This file is automatically generated. DO NOT EDIT
`)
			...
			for _, methodName := range methodNames {
				...
				if b.obfuscate {
					...
					sign := fmt.Sprintf("%s.%s.%s", packageName, structName, methodName)
					jsoutput.WriteString("    // " + sign + "\n")
					...
					if route, exist := b.routeMap[sign]; exist {
						...
						if argsString != "" {
							if route.Method == "get" {
								jsoutput.WriteString("        params: arg1\n")
							} else {
								jsoutput.WriteString("        data: arg1\n")
							}
						}
						jsoutput.WriteString("    })")
					} else {
					...
					// params := fmt.Sprintf("    let method = \"%s.%s.%s\";\n", packageName, structName, methodName)
					// //params += fmt.Sprintf("    let params = \"%s\";", argsString)
					// params += fmt.Sprintf("    let params = \"%s\";", route.Path)
					// jsoutput.WriteString(params)
